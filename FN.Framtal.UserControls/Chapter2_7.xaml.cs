...
namespace FN.Framtal.UserControls
{
    public partial class Chapter2_7 : UserControl
    {
        ...
        public static readonly DependencyProperty PrefixTextBlockWidthProperty = DependencyProperty.Register(nameof(PrefixTextBlockWidth), typeof(double), typeof(Chapter2_7), new PropertyMetadata(OnPrefixWidthPropertyChanged));
        ...
        public double PrefixTextBlockWidth
        {
            get => (double)GetValue(PrefixTextBlockWidthProperty);
            set => SetValue(PrefixTextBlockWidthProperty, value);
        }
        ...
        private static void OnPrefixWidthPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((Chapter2_7)d).PrefixBorder.Width = (double)e.NewValue;
